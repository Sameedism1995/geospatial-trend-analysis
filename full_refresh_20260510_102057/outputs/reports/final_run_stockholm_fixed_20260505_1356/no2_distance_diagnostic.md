...
- Mean of sliding-window NO2 means inside 200–500 km: **1.118e-05** (n_obs ≈ 27054).
- Mean of sliding-window NO2 means outside that band (within 1000 km): **1.976e-05** (n_obs ≈ 137835).
- Ratio (band / outside): **0.57**.
- Raw observation comparison: NO2 mean <200 km = 1.278e-05, 200–500 km = 1.188e-05, >500 km = 2.173e-05.
...
- Observations contributing to the 200–500 km band (raw cells): **5039**.
- Hub composition in 200–500 km band: `{'Mariehamn': 5039}`.
- Hub composition over the full dataset (with valid NO2): `{'Mariehamn': 33238, 'Naantali': 3073, 'Turku': 1990}`.
