...
- Mean of sliding-window NO2 means inside 200–500 km: **1.067e-05** (n_obs ≈ 561).
- Mean of sliding-window NO2 means outside that band (within 1000 km): **2.128e-05** (n_obs ≈ 45615).
- Ratio (band / outside): **0.50**.
- Raw observation comparison: NO2 mean <200 km = 1.272e-05, 200–500 km = 1.015e-05, >500 km = 2.173e-05.
...
- Observations contributing to the 200–500 km band (raw cells): **85**.
- Hub composition in 200–500 km band: `{'Stockholm': 44, 'Mariehamn': 41}`.
- Hub composition over the full dataset (with valid NO2): `{'Mariehamn': 5088, 'Stockholm': 4291, 'Naantali': 3073, 'Turku': 1990}`.
