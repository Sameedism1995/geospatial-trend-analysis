...
- Dataset: `/Users/sameedahmed/Documents/geospatial trend analysis/full_refresh_20260510_102057/processed/features_ml_ready.parquet`
- Rows × cols: **[16065, 46]**
...
- Pairs flagged: 22
  ...
  - `distance_to_port_km` ↔ `distance_to_nearest_high_vessel_density_cell` (r=+0.9997)
  - `oil_slick_probability_t` ↔ `oil_slick_count_t` (r=+0.9989)
  - `oil_slick_count_t` ↔ `detection_score` (r=+0.9989)
...
| `oil_slick_probability_t` | 94.59 |
| `detection_score` | 94.59 |
| `grid_cell_id` | 100.00 |
