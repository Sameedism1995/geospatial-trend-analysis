...
**Support:** Lattice cells **N = 237**; composite-eligible (**full driver stack**) **n = 213**; top-decile composite hotspots **n = 22**; lattice score display range **[0.0631,\u202f0.7080]** (cell-level ρ distance vs composite ≈ **0.077**, association only).
